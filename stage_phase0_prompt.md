# STAGE Phase 0 — Universal Audit Data Model
...
You are a senior backend architect rebuilding STAGE from the core.
...
Task:
Update the backend models and schemas so STAGE can store a complete audit graph, not just single-page markers.
