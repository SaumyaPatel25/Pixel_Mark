...
async def export_dom_edits_css(session_id: str, request: Request, db: AsyncSession = Depends(get_db)):
    ...
    css_lines = [f"/* STAGE DOM Edit Export — Session: {sess.title} */", ""]
...
async def export_dom_edits_ai_implementation(session_id: str, request: Request, db: AsyncSession = Depends(get_db)):
    ...
    ai_lines = [
        "# AI_IMPLEMENTATION.md — STAGE DOM Editing Implementation Guide",
        "",
        "> **Developer & AI Assistant Note:**",
        "> This document is automatically generated by STAGE DOM Editing Mode. It describes human-reviewed design adjustments",
