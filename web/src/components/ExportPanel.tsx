...
export function ExportPanel({ projectId, projectName, commentCount, onClose }: Props) {
  ...
  return (
    <motion.div
      ...
      className="absolute top-24 right-8 z-[60] w-96 bg-[#121216]/95 backdrop-blur-3xl border border-white/10 rounded-[40px] shadow-[0_32px_128px_rgba(0,0,0,0.8)] overflow-hidden animate-in fade-in zoom-in-95 duration-200"
    >
      {showGithub ? (
        <div>
               ...
               <div>
                  <h3 className="text-xl font-black tracking-tighter text-white flex items-center gap-2">
                    <button 
                      ...
                      className="hover:text-purple-400 transition-colors mr-1 flex items-center"
                  ...
                  <p className="text-[10px] font-black text-white/20 uppercase tracking-widest mt-1">Enterprise Issue Sync</p>
               </div>
          ...
          <GitHubExportPanel projectId={projectId} />
        </div>
      ) : (
        <>
          <div className="p-8 pb-4">
          ...
          <div className="px-8 py-6 bg-white/[0.02] border-t border-white/[0.03] space-y-4">
            <div className="flex items-center justify-between">
                ...
                <button 
                  ...
                  className="px-3 py-1 rounded-full bg-purple-500/10 border border-purple-500/20 text-[8px] font-black text-purple-400 uppercase tracking-widest hover:bg-purple-500/20 transition-all"
                >
                    Sync GitHub
                </button>
            </div>
