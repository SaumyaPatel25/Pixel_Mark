...
export default function WhySTAGESection() {
  const objections = [
    {
      icon: Shield,
      title: "Is it secure?",
    ...
    },
    {
      ...
      description: "Never. STAGE is extension-free. Clients drop feedback on raw browser elements dynamically—no Chrome extension installations required.",
