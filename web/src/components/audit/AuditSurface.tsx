        ...
        <div className="bg-[#0d0d14] border-b border-white/5 text-white/60 text-xs px-5 h-12 flex items-center justify-between z-20 select-none gap-4">
          ...
          <div className="flex items-center gap-3 min-w-0">
            <button
              ...
              className={cn(
                "p-1.5 rounded-xl transition-all flex-shrink-0 border border-transparent",
          ...
          <div className="flex items-center gap-3 flex-shrink-0">
            ...
            {/* ── SECONDARY: Advanced Marker Mode toggle ─────────────────── */}
            <div className="flex items-center gap-2 bg-white/[0.03] border border-white/5 px-3 py-1 rounded-xl">
              ...
              <button
                ...
                className={cn(
                  "relative inline-flex h-5 w-10 items-center rounded-full transition-colors outline-none focus:ring-1 focus:ring-purple-500",
          ...
          <div className="p-5 flex flex-col gap-5 flex-1">
                ...
                {ISSUE_TYPES.map((t) => {
                  ...
                  return (
                    <button
                      ...
                      className={cn(
                        "h-9 rounded-xl font-bold text-[9px] uppercase tracking-widest border transition-all flex items-center justify-center gap-1.5 px-2",
                        active
            ...
            <div className="space-y-2">
              ...
              <textarea
                ...
                className="w-full bg-white/[0.03] border border-white/[0.08] text-white placeholder:text-white/20 p-4 rounded-2xl text-xs focus:ring-1 focus:ring-purple-500 focus:border-purple-500/50 outline-none resize-none leading-relaxed transition-all"
              />
            </div>
              ...
              <div className="grid grid-cols-4 gap-1.5">
                {(['low', 'medium', 'high', 'critical'] as Severity[]).map((s) => (
                  <button
                    ...
                    className={cn(
                      "h-8 rounded-xl font-bold text-[8px] uppercase tracking-widest border transition-all",
                      severity === s
          ...
          <div className="p-5 border-t border-white/5 flex flex-col gap-2 flex-shrink-0">
            {submitSuccess ? (
              ...
              <button
                ...
                className="h-12 w-full rounded-2xl bg-purple-600 hover:bg-purple-500 disabled:bg-purple-900/40 disabled:text-white/30 text-white font-extrabold text-[10px] uppercase tracking-widest transition-all flex items-center justify-center gap-2 shadow-lg shadow-purple-950/30"
              >
            ...
            <button
              type="button"
              onClick={() => { setIsDrawerOpen(false); setCaptureCtx(null) }}
              className="h-10 w-full rounded-2xl bg-white/[0.03] hover:bg-white/[0.07] text-white/50 hover:text-white/80 font-black text-[9px] uppercase tracking-widest transition-all"
            >
              Cancel
            </button>
          </div>
