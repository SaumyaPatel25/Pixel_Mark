...
export default function RegisterClient() {
  ...
  const handleGithubSignIn = async () => {
    ...
    try {
      ...
      console.warn('[Auth] Firebase GitHub registration notice:', err);
          ...
          <div className="w-full max-w-[420px] space-y-7">
            ...
            {phase === 'success' ? (
              ...
              >
                {isDirectLogin ? (
                  <>
                    <div className="w-14 h-14 bg-emerald-100 dark:bg-emerald-950/40 text-emerald-600 dark:text-emerald-400 rounded-full flex items-center justify-center mx-auto text-xl font-bold">
                      🎉
                    </div>

                    <div className="space-y-2">
                      <h2 className="text-xl font-bold text-slate-800 dark:text-slate-100">Account Created!</h2>
                  ...
                  <>
                    ...
                    <div className="space-y-2">
                      ...
                      <p className="text-xs text-slate-500 dark:text-slate-400 leading-relaxed">
                        We've sent a passwordless sign-in link to <strong className="text-indigo-600 dark:text-indigo-400">{email}</strong>. Click the link in your email to complete registration.
                      </p>
                    </div>
