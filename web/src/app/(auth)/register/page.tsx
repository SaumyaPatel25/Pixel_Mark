...
export default function RegisterPage() {
  ...
  // Password strength helper for local rendering
  ...
  // State and sequence is managed via ScenePhase state machine
              ...
              {(phase === 'projecting' || phase === 'submitting' || phase === 'error') && (
                ...
                >
                  ...
                  <div className="text-center space-y-4">
                    <div className="inline-flex w-12 h-12 rounded-2xl bg-gradient-to-tr from-cyan-600 to-indigo-600 items-center justify-center text-white shadow-xl shadow-cyan-500/20 mb-2">
