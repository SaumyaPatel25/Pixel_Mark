...
export const faqs: FAQItem[] = [
  {
    ...
    answer: "STAGE is a visual website feedback tool and bug reporting platform. It allows clients, designers, and QA testers to click anywhere on a live website and pin visual feedback directly on the page without screenshots, downloads, or extensions."
  },
  {
  ...
  },
  {
    ...
    answer: "Yes. STAGE works on live websites, staging environments, and local dev servers. It dynamically loads your web pages through a secure visual review session and overlays a collaborative feedback layer so you can annotate in real-time."
  },
  {
  ...
  },
  {
    ...
    answer: "You can reach out directly to Saumya Patel and the Entrext Labs engineering team at team@stage.dev or via our LinkedIn company page. We are always active and ready to assist with custom workspace integrations and feedback reviews."
  }
];
